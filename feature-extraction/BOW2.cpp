...
int main(int argc, char*argv[])
{
	...
	for(int i=1;i<186;i++)
	{
		...
		FileStorage fs1("descriptorSW-a-1.yml", FileStorage::APPEND);
	    sprintf(filename,"/media/rahim/01D051E78FFCF7C0/Lab/Dataset/EyeHead/HPEG/HPEG/session_a/videos/face-s-a/1/%05d.jpg",i);
